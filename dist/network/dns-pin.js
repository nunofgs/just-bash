 ...
 */
export function pinDns(pinned, fn) {
    installDnsHook();
    if (!pinningStore)
        return fn();
 ...
 */
export function _ensureDnsHookInstalled() {
    installDnsHook();
}
