 ...
 */
import { decodeBytesToUtf8, encodeUtf8ToBytes, latin1FromBytes, readBytesFrom, unsafeBytesFromLatin1, } from "../encoding.js";
    ...
    async executeScript(node) {
        ...
        for (const statement of node.statements) {
            try {
                ...
                appendOutput(decodeBytesToUtf8(unsafeBytesFromLatin1(result.stdout)), result.stderr);
