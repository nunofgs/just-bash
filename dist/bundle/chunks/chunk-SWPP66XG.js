...
`),n++):t[n]>s[o]?(l||(u+=`${h}${s[o]}
`),o++):(f||(u+=`${w}${t[n]}
`),n++,o++);return{stdout:u,stderr:"",exitCode:0,stdoutKind:"text"}}},L={name:"comm",flags:[{flag:"-1",type:"boolean"},{flag:"-2",type:"boolean"},{flag:"-3",type:"boolean"}],needsArgs:!0,minArgs:2};export{E as a,L as b};
